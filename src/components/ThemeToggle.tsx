...
export default function ThemeToggle() {
  ...
  // Estado para garantir que o componente só renderiza depois do cliente carregar
  ...
  // Previne erros de hidratação mostrando um espaço vazio até o tema carregar
